...
void PrismElement::doComputeFeEntry(const Mesh * mesh, std::size_t localEdge1, std::size_t localEdge2, dcomplex & i1, dcomplex & i2) const
{
...
void PrismElement::doEdgeNodes(std::size_t index, int32_t & localNode1, int32_t & localNode2) const
{
...
void PrismElement::edgeConstants(std::size_t edge, std::size_t& k1, std::size_t& k2) const
{
...
double PrismElement::ixs(double a, double const * x, double const * y) const
{
  return (-a*math::triangleArea(x,y));
}

double PrismElement::iys(double a, double const * x, double const * y) const
{
  return (-a*math::triangleArea(x,y));
}

double PrismElement::ixxs(double a, double b, double const * x, double const * y) const
{
  return (sxx(x,y) + a*b*math::triangleArea(x,y) );
}

double PrismElement::iyys(double a, double b, double const * x, double const * y) const
{
  return (syy(x,y) + a*b*math::triangleArea(x,y) );
}

double PrismElement::izzl(double zl, double zu, double a, double b) const
{
...
double PrismElement::sxx(double const * x, double const * y) const
{
  double ret = 0.0;
...
double PrismElement::syy(double const * x, double const * y) const
{
  double ret = 0.0;
  for (int node = 0; node < 3; node++)
    ret += y[node]*y[node];
...
double PrismElement::sxy(double const * x, double const * y) const
{
  double ret = 0.0;
  for (int node = 0; node < 3; node++)
    ret += x[node]*y[node];
